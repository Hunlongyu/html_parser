...
namespace hps {
	...
	QueryEngine QueryEngine::event() const {
		return {};
	}

	QueryEngine QueryEngine::odd() const {
		return {};
	}
	...
	QueryEngine QueryEngine::querySelector(std::string_view css_selector) const {
		return {};
	}

	QueryEngine QueryEngine::querySelectorAll(std::string_view css_selector) const {
		return {};
	}
